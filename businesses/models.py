...
class Business(models.Model):
    ...
    about = models.CharField(max_length=500, blank=False, null=True)
    category = models.TextField(max_length= 500, blank= False, null = False, default="all")
    delivery_options = models.TextField(max_length= 500, blank=True, null=True)
